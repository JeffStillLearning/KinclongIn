...
class _AdminEditProfilePageState extends State<AdminEditProfilePage> {
  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      if (user != null) {
        print('Updating admin profile for UID: ${user.uid}');
        print('New username: ${_usernameController.text.trim()}');
        ...
        if (!docSnapshot.exists) {
          print('Admin document does not exist, creating...');
          ...
          print('Admin document exists, updating username...');
        ...
        if (mounted) {
          final userProvider = context.read<UserProvider>();
          print('Current username before update: ${userProvider.username}');

          userProvider.setUsername(_usernameController.text.trim());
          print('Username after setUsername: ${userProvider.username}');

          // Force refresh user data from Firestore
          await userProvider.refreshUser();
          print('Username after refresh: ${userProvider.username}');
